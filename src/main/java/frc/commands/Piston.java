...
public class Piston extends Command {
  ...
  public static enum PisReleaseOrHold { release, hold };
  private PisReleaseOrHold relHold;
  private int counter;
  private static final int counterMax = 25;

  public Piston(PisReleaseOrHold relHold) {
  ...
  protected void execute() {
    if (relHold == PisReleaseOrHold.hold) {
      if (counter==0) {
        hatch.pistonReset();
